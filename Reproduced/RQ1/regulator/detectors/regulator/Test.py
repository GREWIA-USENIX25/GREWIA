...
path = '/Evaluation/regulator/detectors/regulator/regexes'
...
def do_task(id):
    ...
    output = os.popen("timeout --preserve-status -k 5 600 python3 main.py --regex-file '{}' --fuzzer-binary /Evaluation/regulator/detectors/regulator/fuzzer/build/fuzzer_stripped --flags gm --no-binary-search --v --ftime 5000 --ptime 5000".format(os.path.join(path, str(id)+'.txt')))
